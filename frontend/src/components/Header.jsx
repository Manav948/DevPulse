        ...
        <div className="w-full flex justify-center px-4 pt-4 sm:pt-6">
            <header className="w-full max-w-6xl h-14 sm:h-16 px-4 sm:px-6 flex items-center justify-between 
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                    <h1 className="text-lg sm:text-xl font-bold bg-linear-to-r from-green-400 to-emerald-500 
                        bg-clip-text text-transparent">
                        DevPulse
                    </h1>

                    <div className="hidden sm:flex items-center gap-2 text-xs text-green-400 relative">
                ...
                <div className="flex items-center gap-3 relative" ref={dropdownRef}>
                    ...
                    {open && (
                        <div className="absolute right-0 top-12 sm:top-14 w-52 sm:w-56 rounded-xl border border-green-500/10 
                            bg-black backdrop-blur-xl shadow-[0_0_25px_rgba(34,197,94,0.15)] p-2 z-50">
