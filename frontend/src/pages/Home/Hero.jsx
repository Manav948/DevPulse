  ...
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center text-white overflow-hidden bg-black px-4">
      ...
      <div className="relative z-10 text-center max-w-4xl">
        <div
          ref={badgeRef}
          className="inline-block mb-4 sm:mb-6 px-4 py-1 rounded-full border border-green-500/30 text-green-400 text-xs sm:text-sm"
        >
          Real-time Monitoring Platform
        </div>

        <div className="h-15 sm:h-20 md:h-27.5 overflow-hidden">
          <div
            ref={rotatingTextRef}
          ...
          >
            ...
            <div className="h-15 sm:h-20 md:h-20 flex items-center justify-center">
              Analyze Uptime
            </div>
          </div>
        </div>
